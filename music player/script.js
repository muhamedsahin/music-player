...
const playPauseButton = document.querySelector('.oynatma');
const seekbar = document.querySelector('.oynatma-cubuğu');
const volumeBar = document.querySelector('.ses-düzeyi');
...
function draw() {
    ...
    canvasCtx.fillStyle = 'rgb(19, 20, 25) ';
    ...
    for(let i = 0; i < bufferLength; i++) {
        ...
        canvasCtx.fillStyle = `rgb(255, 106, 0)`;
